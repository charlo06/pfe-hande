...
// Member fields
     ...
     * Constructor. Prepares a new BluetoothComm session.
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            mmDevice = device;
            //MY_UUID_SECURE = mmDevice.getUuids()[0].getUuid();
            //MY_UUID_INSECURE = mmDevice.getUuids()[0].getUuid();
        ...
        public void run() {
            ...
            try {
                ...
                //Bundle bundle = new Bundle();
                //bundle.putString(Constants.TOAST, "Connecting device...");
                mmSocket.connect();
            } catch (IOException e) {
            // Close the socket
            Log.e(TAG, "unable to connect " + mmSocket.toString(), e);
            }
            try {
                ...
                try {
                    ...
                    for (int i = begin; i< bytes; i++) {
                        if (buffer[i] == "#".getBytes()[0]) {
                            ...
                            mHandler.obtainMessage(Constants.MESSAGE_READ, begin, i, buffer)
